...
int main() {
	cerr << "load environment." << endl;
	long long secTimeout = 60000;
	int randSeed = 1734;
	ifstream is("D:\\forCode\\npbenchmark.data-data\\PCP\\Instance\\u1817p130.txt");
	ofstream out("D:\\forCode\\output.txt");
	test(is, out, secTimeout, randSeed);
	return 0;
}
*/
